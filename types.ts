...
export type Tab = 'feed' | 'activities' | 'attendance' | 'projects' | 'profile' | 'members' | 'playground' | 'resources' | 'chat' | 'showcase' | 'suggestions' | 'challenges' | 'arena' | 'roadmap' | 'community' | 'games' | 'admin' | 'voting';
